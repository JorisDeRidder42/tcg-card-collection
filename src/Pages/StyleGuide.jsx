...
const StyleGuide = () => {
  return (
    <div className="styleguide-page container-fluid py-5">
      ...
      <section>
        <div>
          <h1 className="text-gradient">Pokédex Collection</h1>

          <h2>My Collection</h2>

          <p className="text-muted">Track your cards</p>
        </div>
      </section>
      <section>
        {/* =========================
...
========================= */}
        ...
        <section className="mt-5">
          <div className="d-flex flex-wrap gap-3">
            <span className="badge-style fire">🔥 Fire</span>
            <span className="badge-style water">💧 Water</span>
            <span className="badge-style grass">🌿 Grass</span>
            <span className="badge-style electric">⚡ Electric</span>
            <span className="badge-style dragon">🐉 Dragon</span>
          </div>
          <h5 className="mt-4">Rarity</h5>
          <div className="d-flex flex-wrap gap-3">
            <span className="badge-style legendary">⭐ Legendary</span>
            <span className="badge-style rare">✨ Rare</span>
            <span className="badge-style holo">🎴 Holo</span>
            <span className="badge-style common">Common</span>
          </div>
        </section>
        {/* =========================
                        PROGRESS BARS
...
========================= */}
        ...
        <section className="mt-5">
          ...
          <div className="mb-4">
            ...
            <ProgressBar now={72} className="pokemon-progress" />
          </div>
          ...
          <div className="mb-4">
            ...
            <ProgressBar now={100} className="pokemon-progress success" />
          </div>
          ...
          <div className="mb-4">
            ...
            <ProgressBar now={25} className="pokemon-progress danger" />
          </div>
        </section>
      </section>
      <section className="mt-5">
        ...
        <p>Track your Pokémon cards.</p>

        <p className="text-muted">Last updated today</p>
      </section>
    </div>
  );
};
